...
I also downloaded the MOT testing data lookup tables to help me make sense of the data.
...
## Key Insights
With the data I cleaned, I plan to answer the following questions
### Descriptive Analysis 
1. What is the overall pass vs fail rate?
2. What is the trend in pass rates over time?
3. What is the average vehicle age at test?
4. What is the average mileage at time of test?

### 🚗 Vehicle Insights 
5. Which car makes/models fail the most?
